...
public class InstructionsManager : MonoBehaviour
{
    ...
    private readonly string[] instructions = new string[2]
    {
        ...
        "You will face up to [###] questions across the same five categories. Players in <font=AbyssSurface><color=blue>The Abyss</color></font> arena have had their lives refreshed.\n\n" +

        "Gameplay is identical to previously. Extra lives are no longer awarded and players who drop into <font=AbyssSurface><color=blue>The Abyss</color></font> will not be replaced.\n\n" +
