...
{
    public enum HostEventType { Default, Validate, Validated, SecondInstance, Leaderboard, PrepForQuestion, QuestionPacket, AnswerPacket, DataFields, Clear, GameOver, WrongApp, WRONGAPP };
